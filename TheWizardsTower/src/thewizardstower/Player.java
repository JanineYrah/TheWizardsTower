...
/**
 * This class represents the player character class, which extends from the Entity class.
 * @author Itzle
 */
public class Player extends Entity {
    ...
    /**
     * This method allows the player to update their movement based on the key that they pressed, that can change speed and direction.
     ...
     * @param g2 Is a Graphics2D parameter that allows the Player character sprite image to be updated
     * @return Returns and draws the correct image sprite of the player character when it moves to different directions.
     */
