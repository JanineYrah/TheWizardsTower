...
public class MainMenuSettings extends JFrame {
    ...
    public MainMenuSettings() {
        ...
        try { //Placing settings font logo in button
            titleimg = ImageIO.read(getClass().getResourceAsStream("/assets/imgs/Settings.png")).getScaledInstance(300, 150, java.awt.Image.SCALE_SMOOTH);
        ...
        volumeTitle.setFont(new Font(Font.MONOSPACED, Font.PLAIN, 15));
        sliderPanel.add(volumeTitle, gbc);
        
        gbc.gridy = 2;
        gbc.anchor = GridBagConstraints.EAST;
        soundFXTitle = new JLabel("SoundFX", SwingConstants.CENTER);
        soundFXTitle.setFont(new Font(Font.MONOSPACED, Font.PLAIN, 15));
       ...
       //buttons
        ...
        easy.setText("Easy");
        easy.setFont(new Font("Monospaced", easy.getFont().getStyle(), easy.getFont().getSize()));
        
        JRadioButton medium = new JRadioButton();
        medium.setText("Medium");
        medium.setFont(new Font("Monospaced", medium.getFont().getStyle(), medium.getFont().getSize()));
        
        JRadioButton hard = new JRadioButton();
        hard.setText("Hard");
        hard.setFont(new Font("Monospaced", hard.getFont().getStyle(), hard.getFont().getSize()));
